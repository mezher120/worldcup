...
export function octavos(info) {
    return { type: info.group, payload: info}
}

export function cuartos(fase, info) {
    return { type: fase, payload: info}
}

export function semis(fase, info) {
    console.log(info, fase, "actions");
    return { type: fase, payload: info}
}

export function final(fase, info) {
    console.log(info, fase, "actions");
    return { type: fase, payload: info}
}

export function terceros(fase, info) {
    console.log(info, "LLEUGE A 3EROS");
    return { type: fase, payload: info}
}